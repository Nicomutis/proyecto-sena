...
<body>
    ...
    <main>
        ...
        <section class="features">
            <div class="feature">
                <h3>Fácil de usar</h3>
                <p>Nuestra plataforma es intuitiva y fácil de navegar.</p>
            </div>
            <div class="feature">
                <h3>Comparaciones precisas</h3>
                <p>Comparamos precios en tiempo real de las principales tiendas.</p>
            </div>
            <div class="feature">
                <h3>Ahorra dinero</h3>
                <p>Encuentra las mejores ofertas y promociones disponibles.</p>
            </div>
        </section>
    </main>
