<?php
	require_once('funs.php'); // Incluye el archivo de funciones útiles
	...
	<div class="row">
		<ol class="breadcrumb">
			...
			<li><a href="cronograma.php">Calendario y Sesiones</a></li> <!-- Enlace a la página del calendario y sesiones -->
			<li class="active">Eliminar Sesión</li> <!-- Indica que estamos en la página para eliminar una sesión -->
		</ol>
	</div><!--/.row-->

	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Eliminar Sesión</h1> <!-- Título de la página -->
		</div>
	</div><!--/.row-->

	<div class="row">
		<div class="error">
			<?php delete_event($event_id, $role); ?> <!-- Llama a la función para eliminar el evento con el ID especificado -->
		</div>
			...
			<div class="panel panel-danger"> <!-- Panel de advertencia con estilo de peligro -->
				...
				<div class="panel-body">
					<form class="" method="post" action="">
						<label for="ask">¿Realmente deseas eliminar esta sesión?</label> <!-- Pregunta de confirmación -->
						<br>
						<div class="panel-footer">
							<div class="pull-right">
								<button class="btn btn-danger" name="yes" type="submit" id="login">Sí</button> <!-- Botón para confirmar la eliminación -->
								&nbsp;&nbsp;
								<a href="cronograma.php" class="btn btn-default" id="login">No, volver</a> <!-- Enlace para cancelar y regresar a la página del calendario y sesiones -->
							</div>
						</div>
					</form>
				</div>
