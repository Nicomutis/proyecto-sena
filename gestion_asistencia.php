...
?>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Registrar Asistencia para la Sesión</h1> 
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-offset-2 col-lg-6">
				<div class="panel panel-primary">
					<div class="panel-heading">
						Marcar Todos los Miembros Presentes 
					</div>
					<div class="panel-body">
						...
						<div class="panel-footer">
							<button class="btn btn-primary pull-left" name="submit_attendance" type="submit" id="login">Guardar Asistencia</button>&nbsp;&nbsp; 
							<a href="notice.php" class="btn btn-default" id="login">Cancelar</a> 
						</div>
						</div>
						</form>
					</div>
