...
?>
	<div class="row">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Publicaciones en <?php echo $getcategory; ?></h1> 
			</div>
		</div><!--/.row-->
		...
		<div class="col-lg-5">
			...
			<a href="buscador.php?cat=<?php echo $row['catinfo']; ?>"><?php echo $row['catinfo']; ?></a>
			    ...
			    <?php
			    	...
			    	<?php }
			   	?>
			    <a class="btn btn-primary" href="viewpost.php?id=<?php echo $row['id']; ?>&title=<?php echo $row['postTitle']; ?>">Leer Más</a> 
			    </div></div></div>
			    <?php
			    $select++;
	...
	{
		echo '<div class="text-center alert bg-warning col-md-offset-4 col-md-4" role="alert"><span>No se encontraron publicaciones, inténtalo de nuevo</span></div>'; 
	}
