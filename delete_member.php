<?php
	...
	$mem_id = $_GET['mem_id']; // Obtiene el ID del miembro desde la URL
	...
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Eliminar Miembro</li> <!-- Indica que estamos en la página para eliminar un miembro -->
		</ol>
	</div><!--/.row-->

	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Eliminar Miembro</h1> <!-- Título de la página -->
		</div>
	</div><!--/.row-->

	<div class="row">
		<div class="error">
			<?php delete_member($mem_id, $role); ?> <!-- Llama a la función para eliminar el miembro con el ID especificado -->
		</div>
			...
			<div class="panel panel-danger"> <!-- Panel de advertencia con estilo de peligro -->
				...
				<div class="panel-body">
					<form class="" method="post" action="">
						<label for="ask">¿Realmente deseas eliminar a este miembro?</label> <!-- Pregunta de confirmación -->
						<br>
						<div class="panel-footer">
							<div class="pull-right">
								<button class="btn btn-danger" name="yes" type="submit" id="login">Sí</button> <!-- Botón para confirmar la eliminación -->
								&nbsp;&nbsp;
								<a href="gestion_miembros.php" class="btn btn-default" id="login">No, volver</a> <!-- Enlace para cancelar y regresar a la página de gestión de miembros -->
							</div>
						</div>
					</form>
				</div>
